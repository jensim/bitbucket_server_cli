#### Usage
```
bitbucket_server_cli clone-projects
...
Working repos [00:00:09] [#####>----------------------------------] 189/1337 (eta:1m)
```
#### Help
```
bitbucket_server_cli-clone-projects 0.3.13
Clone projects

USAGE:
    bitbucket_server_cli clone-projects [FLAGS] [OPTIONS]
